        ...
        <form method="POST" action="{{ route('user.edit', ['id' => $user->id]) }}"
            ...
            <div class="form-group">
                <strong> <label for="">Contact number</label></strong>
                 <input type="number" name="number" class="form-control" placeholder="Enter number" value="{{old('number', $user->number)}}">
            ...
            <div class="form-group">
                <strong> <label for="">Address</label></strong>
                 <input type="address" name="address" class="form-control" placeholder="Enter address" value="{{old('address', $user->address)}}">
            ...
            <div class="form-group">
                <strong> <label for="">Fees</label></strong>
                 <input type="number" name="fees" class="form-control" placeholder="Enter fees" value="{{old('fees', $user->fees)}}">
                 @if($errors->has('fees'))
